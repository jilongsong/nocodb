...
<template>
  ...
  >
       <div class="h-full flex items-stretch justify-between bg-white">
      <div class="flex -mt-1">
        <img src="~assets/img/logo.png" alt="form-banner-left'" />
      </div>

      <div class="w-[91px] flex justify-center">
        <img class="max-h-full self-center" src="~assets/img/logo.png" alt="form-banner-logo" />
      </div>
